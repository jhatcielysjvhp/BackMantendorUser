...
namespace Api_Sistema_Usuarios.Repositories
{
    public class UsuarioRepository
    {
        ...
        public async Task<(int idGenerado, int resultado, string mensaje)> Create(UsuarioCreateRequestDto usuarioDto) 
        {
        ...
        public async Task<(int resultado, string mensaje)> Update(UsuarioUpdateRequestDto usuarioDto) 
        {
            using var connection = _dbService.CreateConnection();
            var parameters = new DynamicParameters();
